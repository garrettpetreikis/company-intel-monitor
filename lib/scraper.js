...
const [googleNews, prNewswire, businessWire, tradePress, jobs, thomasnet, website, edgar, importData] =
    await Promise.all([
  ...
  const signals = await analyzeAccount(company, { googleNews, prNewswire, businessWire, tradePress, jobs, thomasnet, website, edgar, importData });
...
async function scrapeCompetitor(company) {
 ...
 const [googleNews, prNewswire, businessWire, tradePress, jobs, thomasnet, website, edgar, reviews, importData] =
    await Promise.all([
  ...
  const signals = await analyzeCompetitor(company, { googleNews, prNewswire, businessWire, tradePress, jobs, thomasnet, website, edgar, reviews, importData });
